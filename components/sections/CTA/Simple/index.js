...
const Container = tw.div`max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between bg-gradient-to-r from-background to-background rounded-lg border border-green`;
...
const PrimaryLink = tw.a`inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-accents_7 bg-green hover:bg-background hover:border border-green hover:text-green`;
